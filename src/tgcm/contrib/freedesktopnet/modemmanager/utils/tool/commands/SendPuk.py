...
class SendPuk(Command):

    def config_cmd(self):
        self.name = "send_puk"
        self.category = "card"
        self.description = "Send puk to Modem"
        self.description_full = "Send puk to Modem"
        self.add_usage = " puk_number pin_number"
    ...
    def run_cmd(self):
        ...
        if len(self.args) == 3 :
            ...
            if c != None:
                c.SendPuk(self.args[1], self.args[2])
                sys.exit(0)
