...
class DeleteSMS(Command):

    def config_cmd(self):
        self.name = "delete_sms"
        self.category = "sms"
        self.description = "Delete sms stored in a modem"
        self.description_full = "Delete sms storend in a modem"
        self.add_usage = ' sms_index_number'
