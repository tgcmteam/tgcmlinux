...
class ChangePin(Command):
    ...
    def config_cmd(self):
        self.name = "change_pin"
        self.category = "card"
        self.description = "Change pin of a modem"
        self.description_full = "Change pin of a modem"
        self.add_usage = " old_pin_number new_pin_number"
    ...
    def run_cmd(self):
        ...
        if len(self.args) == 3 :
            ...
            if c != None:
                c.ChangePin(self.args[1], self.args[2])
                sys.exit(0)
