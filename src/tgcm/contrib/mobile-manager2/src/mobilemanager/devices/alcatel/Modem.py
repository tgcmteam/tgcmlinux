...
class Modem(object):
    ...
    def m_is_operator_locked(self):
        def function(task):
            ...
            if (res is not None) and (res['unlock_status'] == 'PH-NET PIN'):
                is_operator_locked = True

            return is_operator_locked

        task_msg = "[Alcatel] Is Device Operator Locked?"
    ...
    def m_unlock_operator(self, unlock_code):
        ...
        task_msg = "[Alcatel] Device Operator Unlock"
