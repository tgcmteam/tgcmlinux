...
Name: escritorio-movistar-venezuela
Summary: Venezuela Connection Manager
Version: 8.9
Release: 1
License: GPLv2+
...
find $RPM_BUILD_ROOT/etc/xdg/autostart/*.desktop -name tgcm-*.desktop | grep -v tgcm-ve.desktop | xargs rm -f
find $RPM_BUILD_ROOT/usr/share/applications/ -name tgcm-* | grep -v tgcm-ve | xargs rm -f
find $RPM_BUILD_ROOT/usr/share/doc/tgcm/ -maxdepth 1 -type d | grep -v tgcm/ve | grep -ve "tgcm/$" | xargs rm -fr
