...
Name: escritorio-movistar-guatemala
Summary: Guatemala Connection Manager
Version: 8.9
Release: 1
License: GPLv2+
...
find $RPM_BUILD_ROOT/etc/xdg/autostart/*.desktop -name tgcm-*.desktop | grep -v tgcm-gt.desktop | xargs rm -f
find $RPM_BUILD_ROOT/usr/share/applications/ -name tgcm-* | grep -v tgcm-gt | xargs rm -f
find $RPM_BUILD_ROOT/usr/share/doc/tgcm/ -maxdepth 1 -type d | grep -v tgcm/gt | grep -ve "tgcm/$" | xargs rm -fr
